...
saludo_1="Hola genio , bienvenido al juego de las adivinanzas, en esta oportunidad vas a tener 3 intentos para adivinar el numero secreto que pensé, el numero va a ser del 1 al 10"
...
if saludoselecciondo == 1: saludo_seleccionado = saludo_1

elif saludoselecciondo == 2: saludo_seleccionado = saludo_2
