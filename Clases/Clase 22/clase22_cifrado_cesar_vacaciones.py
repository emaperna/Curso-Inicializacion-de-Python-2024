...
if decision_usuario == "E":
    palabra_a_encriptar = input("Escriba para encriptar en formato cesar:")# Le pedimos al usuario la palabra a encriptar
else:
    palabra_a_encriptar = input("Escriba para desencriptar en formato cesar:")# Le pedimos al usuario la palabra a dencriptar
